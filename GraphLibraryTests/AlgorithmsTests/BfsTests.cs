...
namespace GraphLibraryTests.AlgorithmsTests
{
	...
	public class BfsTests
	{
		...
		public void BfsTest3()
		{
			...
			var expectedEdges = new List<OrientedEdge>() { graph.GetEdge("0", "1"), graph.GetEdge("1", "2"), graph.GetEdge("3", "4") };
		...
		public void BfsTest5()
		{
			...
			var edgesList = new List<OrientedEdge>();
			Algorithms.Bfs(graph, v => verticesList.Add(v), e => edgesList.Add(e));
			var expectedVertices = new List<OrientedVertex>() { graph.GetVertex("0"), graph.GetVertex("1"), graph.GetVertex("3"), graph.GetVertex("4"), graph.GetVertex("2") };
			var expectedEdges = new List<OrientedEdge>() { graph.GetEdge("0", "1"), graph.GetEdge("0", "3"), graph.GetEdge("0", "4"), graph.GetEdge("1", "2") };
		...
		public void BfsFromVertexTest1()
		{
			...
			var expectedEdges = new List<OrientedEdge>() { graph.GetEdge("2", "0"), graph.GetEdge("0", "1") };
